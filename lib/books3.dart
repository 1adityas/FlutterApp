...
class _booksyearthreeState extends State<booksyearthree>
  ...
  Widget build(BuildContext context) {
    ...
    data2.add(detail("DBMS", "assets/images/dbms.png",
    ...
    data2.add(detail(
        "Fibre Optics And Opto-Electronics",
